		...
		<div class="row">
			<div class="col-md-offset-4 col-md-4 col-sm-offset-3 col-sm-6">
				<form class="form-horizontal" action="TeacherLogin" method="post">
					<div class="heading">教师登录</div>
					<div class="form-group">
						<i class="fa-user"></i><input required="required" name="teacherId" type="number" class="form-control" placeholder="Username" id="exampleInputEmail1">
					</div>
					<div class="form-group">
						<i class="fa-lock"></i><input required="required" name="teacherPwd" type="password" class="form-control" placeholder="Password">
					</div>
					<div class="form-group">
