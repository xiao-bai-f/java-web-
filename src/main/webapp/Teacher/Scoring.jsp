...
<div class="layui-layout layui-layout-admin">
    <div class="layui-header">
        ...
        <ul class="layui-nav layui-layout-left">
            <li class="layui-nav-item"><a href="/Teacher/Scoring" title="刷新"><i class="layui-icon layui-icon-refresh-3"></i></a></li>
    ...
    <div class="layui-body" style="background-color: #e2e2e2">
        ...
        <div class="container" align="center">
            <h2 align="ceter">论文评分</h2>
            <div style="margin-left: 35px" align="left">
            ...
            <table style="width: 1400px;" align="center" class="table table-striped table-hover table-bordered">
                ...
                <tr>
                    ...
                    <th><strong>学生编号</strong></th>
                    <th><strong>学生姓名</strong></th>
                    <th><strong>课题编号</strong></th>
                    <th><strong>课题名称</strong></th>
                    <th><strong>开题报告</strong></th>
                    <th><strong>中期检查报告</strong></th>
                    <th><strong>论文初稿</strong></th>
                    <th><strong>论文定稿</strong></th>
                    <th><strong>论文终稿</strong></th>
    ...
    <div class="white_content" id="showdiv">
        ...
        <div>
            <form action="afterScoring" method="post">
            <table style="width: 500px; margin-left:25px;" align="left" class="table table-striped table-hover table-bordered">
                <thead>
                <tr>
                ...
                <tbody>
                    <tr>
                        ...
                        <td><input class="ele" type="number" name="content"></td>
                        <td><input class="ele" type="number" name="think"></td>
                        <td><input class="ele" type="number" name="express"></td>
                        <td><input class="ele" type="number" name="answer"></td>
                        <td><input class="ele" type="number" name="grade"></td>
                        <td><input class="ele" type="submit" value="评分"></td>
                    </tr>
                </tbody></form>
        </div>
    </div>
        ...
        if(PageCount == 1){
            ...
            for(var i = 0; i<lineCount; i++){
                text +="<tr><td>"+(i+1)+"</td>" +
                    ...
                    "<td>"+secondName[i]+"</td>"+
                    "<td>"+lastName[i]+"</td>" +
                    "<td><a href='#' onclick='Scoring(\""+i+"\")'>评分</a></td></tr>";
            }
