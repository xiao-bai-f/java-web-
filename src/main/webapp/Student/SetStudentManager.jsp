...
<body>
	...
	<form action="SetStudentManagerAfter" method="post">
		<p>学生姓名：<input type="text" name="name"></p>
		<p>学生年龄：<input type="number" name="age"></p>
		<p>学生性别：
			<input type="radio" name="sex" value="男">男
			<input type="radio" name="sex" value="女">女
		</p>
		<p>学院名称：
			<select id="college" name="college" onchange="getCollegeSelected();">
				<c:forEach items="${collegeList}" var="college">
					<option value="${college.collegeId}">${college.collegeName}</option>
				</c:forEach>
			</select>
		</p>
		<p id="majorNameList">专业名称：
			<select id="major" name="major" onchange="getMajorSelected();">
				<c:forEach items="${majorList}" var="major">
					<option value="${major.majorId}">${major.majorName}</option>
				</c:forEach>
			</select>
		</p>
		<p id="classIdList">班级编号：
			<select id="classes" name="classes" onchange="getClassesSelected();">
				<c:forEach items="${classList}" var ="classes">
					<option value="${classes.classId}">${classes.classId}</option>
				</c:forEach>
			</select>
		</p>
		<p>学生学历：<select id="xl" name="xl">
			<option value="专科">专科</option>
			<option value="本科">本科</option>
			<option value="硕士">硕士</option>
			<option value="博士">博士</option>
		</select></p>
		<p>学生邮箱：<input type="text" name="mail"></p>
		<p>学生电话号码：<input type="text" name="tel"></p>
		<p>学生地址：
			<p id="provice"></p>
			<p id="city"></p>
			<p id="county"></p>	
